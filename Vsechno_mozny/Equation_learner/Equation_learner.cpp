...
std::vector<std::vector<std::vector<double>>> initialize_koeficients(std::vector<std::vector<function>> net, int inputs , double w_val, double b_val)
{
    ...
    for (int n = 0; n < net_size; n++)
    {
        for (int i = 0; i < inputs; i++)
        {
            try
            {
                if (((net.at(0).at(n) == times) || (net.at(0).at(n) == divide))&&(i==0))
                {
                    net_size = net_size + 1;
                }
            }
...
/*
std::vector<std::vector<std::vector<double>>> batch_gradient_descent(std::vector<double> y0, std::vector<std::vector<double>> x, std::vector<std::vector<function>> net, std::vector<std::vector<std::vector<double>>> koef, double alpha, double tau, int N, double lambda)
{
    double d_koef = 0;
    double max_d_koef;
...
std::vector<std::vector<std::vector<double>>> batch_gradient_descent(std::vector<double> y0, std::vector<std::vector<double>> x, std::vector<std::vector<function>> net, std::vector<std::vector<std::vector<double>>> koef, double alpha, double tau, int N)
{
    return batch_gradient_descent(y0, x, net, koef, alpha, tau, N, 0.0);
}
...
std::vector<std::vector<std::vector<double>>> batch_gradient_descent(std::vector<double> y0, std::vector<double> x, std::vector<std::vector<function>> net, std::vector<std::vector<std::vector<double>>> koef, double alpha, double tau, int N, double lambda)
{
    ...
    return batch_gradient_descent(y0, std::vector<std::vector<double>>{x}, net, koef, alpha, tau, N, lambda);
}
...
std::vector<std::vector<std::vector<double>>> stochastic_gradient_descent(std::vector<double> y0, std::vector<std::vector<double>> x, std::vector<std::vector<function>> net, std::vector<std::vector<std::vector<double>>> koef, double alpha, double tau, int N, double ratio, double lambda)
{
    ...
    return (lambda == 0.0)?batch_gradient_descent(y0, x, net, koef, alpha, tau, N): batch_gradient_descent(y0, x, net, koef, alpha, tau, N, lambda);
}

std::vector<std::vector<std::vector<double>>> stochastic_gradient_descent(std::vector<double> y0, std::vector<std::vector<double>> x, std::vector<std::vector<function>> net, std::vector<std::vector<std::vector<double>>> koef, double alpha, double tau, int N, double ratio)
{
    return stochastic_gradient_descent(y0, x, net, koef, alpha, tau, N,ratio,0.0);
}

std::vector<std::vector<std::vector<double>>> stochastic_gradient_descent(std::vector<double> y0, std::vector<double> x, std::vector<std::vector<function>> net, std::vector<std::vector<std::vector<double>>> koef, double alpha, double tau, int N, double ratio, double lambda)
{
    return stochastic_gradient_descent(y0, std::vector<std::vector<double>>{x}, net, koef, alpha, tau, N, ratio, lambda);
}
...
{
    return stochastic_gradient_descent(y0, std::vector<std::vector<double>>{ x }, net, koef, alpha, tau, N, ratio, 0.0);
}
*/
...
void plot(std::vector<std::vector<double>> x, std::vector<double> y, int Q)
{
    plot(y, Q);
    ...
    for (int j = 0; j < x.size(); j++)
    {
        ...
        for (int i = 0; i < x.at(j).size() - 2; i++)
        {
            std::cout << " ";
        }

        std::cout << x.at(j).at(x.at(j).size() - 1) << "\n";
    }

    std::cout << "\n";
}

void plot(std::vector<std::vector<double>> x, std::vector<std::vector<double>> y, int Q)
{
    plot(y, Q);
...
int main()
{
    ...
    for (int i = 0; i < regularization_range.size(); i++)
    {
        ...
        koef = ADAM(y0, x, net, initialize_koeficients(net, x.size(), 1.0, 1.0), alpha, tau, N,regularization_range.at(i));
